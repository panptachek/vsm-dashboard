...
function PreviewPane({
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* sections */}
      <PreviewSection title="Перевозки" items={payload.transport} fields={['material', 'from_location', 'to_location', 'volume', 'unit']} />
      <PreviewSection title="Основные работы" items={payload.main_works} fields={['work_name', 'constructive', 'pk_start', 'pk_end', 'volume', 'unit']} />
      <PreviewSection title="Сопутствующие работы" items={payload.aux_works} fields={['work_name', 'volume', 'unit', 'comment']} />
      <PreviewSection title="Парк техники" items={payload.park} fields={['equipment_type', 'brand_model', 'plate_number', 'operator_name', 'ownership_type', 'contractor_name']} />
      <PreviewSection title="Персонал" items={payload.personnel} fields={['category', 'count']} />
